...
# 1. Initialize static-ffmpeg (for automatic cloud & cross-platform FFmpeg binary support)
try:
    import static_ffmpeg
    static_ffmpeg.add_paths()
    print("[Engine] static-ffmpeg cross-platform paths initialized.")
except Exception as e:
    pass

# 2. Add local tools (FFmpeg & Deno) to PATH if present
if os.path.exists(FFMPEG_DIR):
    os.environ["PATH"] = FFMPEG_DIR + os.pathsep + os.environ.get("PATH", "")
    print(f"[Engine] Bundled tools (FFmpeg & Deno) active from: {FFMPEG_DIR}")

# 3. Embedded cookie backup to ensure 100% bypass of cloud datacenter bot blocks
EMBEDDED_COOKIES = """# Netscape HTTP Cookie File
# This file is generated by yt-dlp.  Do not edit.

.youtube.com	TRUE	/	FALSE	0	PREF	volume=38&f7=100&tz=UTC&repeat=NONE&f4=4010000&autoplay=true&f5=30000&hl=en
.youtube.com	TRUE	/	TRUE	0	SOCS	CAI
.youtube.com	TRUE	/	TRUE	1802923490	VISITOR_INFO1_LIVE	TxudLQdusUg
.youtube.com	TRUE	/	TRUE	1802923490	VISITOR_PRIVACY_METADATA	CgJJThIEGgAgJg%3D%3D
.youtube.com	TRUE	/	TRUE	1800043658	YT_CL	{"loctok":"ACih6ZPbaPvrsg8ZasB1aQTIxjd_YC-UOCp_YFteQV3-FIhVlrrZhYOdPDYNjMCyNoL7x2Y8vQ4DKsPtgs3-JR38hko"}
.youtube.com	TRUE	/	TRUE	1818262843	__Secure-1PSIDTS	sidts-CjUBXMw41Ruy53_L-_5ddtTHbz1F0ytRD4YbzL8yWh6iZUPvU7FLAKKDJ7UE68U1vYy8N1nD9xAA
.youtube.com	TRUE	/	TRUE	1821077104	__Secure-3PAPISID	axP6QQj7-jkQLQF3/AGNh3Uq-qziOAvRb9
.youtube.com	TRUE	/	TRUE	1821077104	__Secure-3PSID	g.a000Agk0TsthNBzX70jaejBJF2pg6mMbhw9Q-NCXs4Y38pNjf7ZprisyTMB4KR5XRo5fY5wS_QACgYKAVESARUSFQHGX2MihiD-gl2CqpBP_gUKZ5TrghoVAUF8yKpCSqD9xuFltdfShGtZQXiJ0076
.youtube.com	TRUE	/	TRUE	1818262843	__Secure-3PSIDCC	AKEyXzWuc3-AC0hJpKAxhEtcE2sNHyWIyI_MerXS8zC0YdRlhfwWNJtCXTepKty3CXmEgVlEqhY
.youtube.com	TRUE	/	TRUE	1818262843	__Secure-3PSIDTS	sidts-CjUBXMw41Ruy53_L-_5ddtTHbz1F0ytRD4YbzL8yWh6iZUPvU7FLAKKDJ7UE68U1vYy8N1nD9xAA
.youtube.com	TRUE	/	TRUE	1802923484	__Secure-ROLLOUT_TOKEN	CNznxuTqr4j_rQEQpLWJmtqplgMYxou7062zlgM%3D
.youtube.com	TRUE	/	TRUE	1802923484	__Secure-YNID	21.YT=ZBHST5OlUMMfJ1DYLqTKYBfssP0iz0IuN3YBHRGD0-lYaUSrYnVnCtmLDW7IUPewr8MVVOa7z8kXTtzIeiOd6NkiJNS3VewU5wjqTZ0e_PVKVOeqQr60tM8QeKKsqzPnbznbCe10nfSwF9zhuoFswm1cF36Yj2gWx69ZuYXSSF8iAgV4wX2n4zpDd4_udpEUG9xFr1qRjlpNNJXw5FRsWuoh0qoyKXQOAIoBv0qvOsZBWhqmH1V69zx8ZLdpADh6wzFyxA4GD-9xXHqEgVVVCZt41ja-8X_0-ztMi1f1bBjbOOdfQtSimszRfB9qOqH1k6aRsK0pWVGHo3bSfqikmA
.youtube.com	TRUE	/	TRUE	1850118843	__Secure-YT_TVFAS	t=496399&s=2
.youtube.com	TRUE	/	TRUE	1802598843	DEVICE_INFO	ChxOelkzTlRNd05EUTJNekEyTXpRME9UWXhOdz09ELvXkNQGGL7RkNQG
.youtube.com	TRUE	/	TRUE	1787373284	GPS	1
.youtube.com	TRUE	/tv	TRUE	1819878843	__Secure-YT_DERP	CN_SksytBg%3D%3D
"""

# Ensure cookies.txt is created
ENV_COOKIES = os.environ.get('YOUTUBE_COOKIES', '').strip()
if ENV_COOKIES:
    try:
        with open(COOKIES_FILE, 'w', encoding='utf-8') as f:
            f.write(ENV_COOKIES)
        print("[Auth] Initialized cookies from YOUTUBE_COOKIES env.")
    except Exception as e:
        print(f"[Auth Warning] {e}")
elif not os.path.isfile(COOKIES_FILE) or os.path.getsize(COOKIES_FILE) < 50:
    try:
        with open(COOKIES_FILE, 'w', encoding='utf-8') as f:
            f.write(EMBEDDED_COOKIES)
        print("[Auth] Auto-generated embedded session cookies for datacenter bot bypass.")
    except Exception as e:
        print(f"[Auth Warning] {e}")
...
if __name__ == '__main__':
    ...
    print(f"  [+] True 4K Engine:      ACTIVE (Datacenter Cookie Bypass)")
